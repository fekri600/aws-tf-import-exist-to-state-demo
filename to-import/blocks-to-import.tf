...
resource "aws_s3_bucket" "drift_demo_bucket_369b" {
  # Imported from arn:aws:s3:::drift-demo-bucket-369b
  name = "drift-demo-bucket-369b"
...
resource "aws_iam_role" "AWSServiceRoleForResourceExplorer" {
  # Imported from arn:aws:iam::490004637046:role/AWSServiceRoleForResourceExplorer
